...
<option value=""></option>
<option value="New Track" selected="selected">New Array</option>
...
<li id="foli16" class="complex notranslate      ">
	...
	<div>
		...
		<label for="Field21">Subarray 1</label>
	</div>
	<div id="subArrayExtra">

	</div>
	<INPUT TYPE=BUTTON OnClick="AddSubarray();" VALUE="+1 Add one" class="left small boton">
</li>
